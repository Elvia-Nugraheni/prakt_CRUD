...
{   
   ...
   $nama_alat= $_POST['nama_alat'];
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE alat SET nama_alat='$nama_alat',tahun='$tahun',merek='$merek',type='$type',no_seri='$no_seri,lokasi='$lokasi' WHERE id=$id");
    ...
    <form name="update_user" method="post" action="edit.php">
        <table border="0">
            ...
            <tr> 
             ...
             <tr> 
                <td>no_seri</td>
                <td><input type="text" name="no_seri" value=<?php echo $no_seri;?>></td>
            </tr>
             <tr> 
                <td>Lokasi</td>
